function NavbarBottom() {
  return (
    <div className="sticky z-20 bottom-0 bg-white flex flex-row justify-between px-5 py-3 border-t sm:hidden">
      <div className="grid justify-items-center gap-y-1">
        ...
        <p className="text-sm text-light1"> Home</p>
      </div>
      ...
      <div className="grid justify-items-center gap-y-1">
        ...
        <p className="text-sm text-light1">Promotions</p>
      </div>
      ...
      <div className="grid justify-items-center gap-y-1">
        ...
        <p className="text-sm text-light1">Others</p>
      </div>
    </div>
  );
}
